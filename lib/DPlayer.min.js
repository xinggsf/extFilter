...
btn.innerHTML = `<svg viewBox="0 0 18 18"><path d="M10.125 1L0 9l10.125 8v-6.171L18 17V1l-7.875 6.171z"></path></svg>`;
btn = this.container.querySelector(".dplayer-forward-icon");
btn.addEventListener('click', e => {this.video.currentTime += 5});
btn.addEventListener('mousedown', e => {e.stopPropagation();if (e.button>0) this.video.currentTime += iStep[e.button-1]});
btn.innerHTML = `<svg viewBox="0 0 18 18"><path d="M7.875 7.171L0 1v16l7.875-6.171V17L18 9 7.875 1z"></path></svg>`;
