!function(e, t) {
        ...
        e.exports = function(e) {
            ...
            t.i = function(e, a, n) {
                ...
                for (var l = 0; l < e.length; l++) {
                    var s = [].concat(e[l]);
                    n && o[s[0]] || (a && (s[2] ? s[2] = "".concat(a, " and ").concat(s[2]) : s[2] = a),
                    t.push(s))
                }
            }
            ,
    ...
    , function(e, t, a) {
        ...
        (function(t) {
            ...
            var l, s = {
                adapter: ("undefined" != typeof XMLHttpRequest ? l = a(10) : void 0 !== t && "[object process]" === Object.prototype.toString.call(t) && (l = a(10)),
                l),
                transformRequest: [function(e, t) {
                    return o(t, "Accept"),
                    o(t, "Content-Type"),
                    n.isFormData(e) || n.isArrayBuffer(e) || n.isBuffer(e) || n.isStream(e) || n.isFile(e) || n.isBlob(e) ? e : n.isArrayBufferView(e) ? e.buffer : n.isURLSearchParams(e) ? (i(t, "application/x-www-form-urlencoded;charset=utf-8"),
                    e.toString()) : n.isObject(e) ? (i(t, "application/json;charset=utf-8"),
                    JSON.stringify(e)) : e
                }
                ],
    ...
    , function(e, t, a) {
        ...
        e.exports = function(e) {
            return new Promise((function(t, p) {
                ...
                if (y.open(e.method.toUpperCase(), r(f, e.params, e.paramsSerializer), !0),
                y.timeout = e.timeout,
                ...
                ,
                y.onabort = function() {
                    y && (p(d("Request aborted", e, "ECONNABORTED", y)),
                    y = null)
                }
                ,
                y.onerror = function() {
            ...
            function d(e, t) {
                ...
                s._immediateFn((function() {
                    ...
                    if (null !== a) {
                        ...
                        (1 === e._state ? p : c)(t.promise, e._value)
                }
                ))) : e._deferreds.push(t)
            }
            function p(e, t) {
    ...
    , function(e, t, a) {
        (function(e, t) {
            !function(e, a) {
                "use strict";
                if (!e.setImmediate) {
                    var n, o, r, i, l, s = 1, d = {}, p = !1, c = e.document, u = Object.getPrototypeOf && Object.getPrototypeOf(e);
                    ...
                    ) : c && "onreadystatechange"in c.createElement("script") ? (o = c.documentElement,
                    n = function(e) {
    ...
    , function(e, t, a) {
        ...
        e.exports = function(e, t) {
            n.forEach(e, (function(a, n) {
                n !== t && n.toUpperCase() === t.toUpperCase() && (e[t] = a,
                delete e[n])
            }
            ))
        }
    ...
    , function(e, t, a) {
        ...
        e.exports = n.isStandardBrowserEnv() ? function() {
            ...
            function o(e) {
                var n = e;
                return t && (a.setAttribute("href", n),
                n = a.href),
    ...
    , function(e, t, a) {
          ...
          , r = {
            ...
            setScrollPosition: function(e) {
                var t = e.left
                  ...
                  , n = e.top
                  , o = void 0 === n ? 0 : n;
                this.isFirefox ? (document.documentElement.scrollLeft = a,
                document.documentElement.scrollTop = o) : window.scrollTo(a, o)
            },
            isMobile: o,
        ...
        var ee = function() {
            ...
            (a = [{
                ...
                value: function(e) {
                    if (void 0 !== e) {
                        for (var t = this.container.getElementsByClassName("dplayer-danmaku-item"), a = 0; a < t.length; a++)
                            t[a].style.opacity = e;
                        this._opacity = e,
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                          ...
                          , d = function(e, a, o) {
                            for (var r = n / s(o), d = function(o) {
                                ...
                                for (var p = 0; p < d.length; p++) {
                                    var c = l(d[p]) - 10;
                                    if (c <= n - r * s(parseInt(d[p].style.width)) || c <= 0)
                                        break;
                                    if (p === d.length - 1)
                                        return t.danTunnel[a][o + ""].push(e),
                                        e.addEventListener("animationend", (function() {
                                            t.danTunnel[a][o + ""].splice(0, 1)
                                        }
                                        )),
                        ...
                        for (var p = document.createDocumentFragment(), c = function(o) {
                            ...
                            switch (e[o].type) {
                            case "right":
                                (s = d(i, e[o].type, l)) >= 0 && (i.style.width = l + 1 + "px",
                                i.style.top = a * s + "px",
                            ...
                            s >= 0 && (i.classList.add("dplayer-danmaku-move"),
                            p.appendChild(i))
                        }, u = 0; u < e.length; u++)
                            c(u);
                ...
                key: "resize",
                value: function() {
                    for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("dplayer-danmaku-item"), a = 0; a < t.length; a++)
        ...
        var ae = function() {
            ...
            (a = [{
                ...
                key: "type",
                value: function(e) {
                    return -1 !== this.playerEvents.indexOf(e) ? "player" : -1 !== this.videoEvents.indexOf(e) ? "video" : (console.error("Unknown event name: ".concat(e)),
                    null)
                }
            }]) && te(t.prototype, a),
            n && te(t, n),
        ...
        var oe = function() {
            function e(t) {
                ...
                var n = function() {
                    a.player.resize(),
                    a.isFullScreen("browser") ? a.player.events.trigger("fullscreen") : (r.setScrollPosition(a.lastScrollPosition),
                  ...
                  , o = function() {
                    ...
                    e && e !== a.player.container || (a.player.resize(),
                    e ? a.player.events.trigger("fullscreen") : (r.setScrollPosition(a.lastScrollPosition),
                    a.player.events.trigger("fullscreen_cancel")))
                };
                /Firefox/.test(navigator.userAgent) ? (document.addEventListener("mozfullscreenchange", o),
                document.addEventListener("fullscreenchange", o)) : (this.player.container.addEventListener("fullscreenchange", n),
            ...
            (a = [{
                ...
                value: function() {
                    ...
                    switch (a || (this.lastScrollPosition = r.getScrollPosition()),
                    e) {
                    case "browser":
            ...
            (a = [{
                ...
                value: function() {
                    ...
                    this.loadingChecker = setInterval((function() {
                        e.enableloadingChecker && (a = e.player.video.currentTime,
                        n || a !== t || e.player.video.paused || (e.player.container.classList.add("dplayer-loading"),
                        n = !0),
                        n && a > t && !e.player.video.paused && (e.player.container.classList.remove("dplayer-loading"),
                        n = !1),
                        t = a)
                    }
                    ), 100)
        ...
        var be = function() {
            ...
            (a = [{
                ...
                value: function() {
                    ...
                    this.player.template.playedBarWrap.addEventListener(r.nameMap.dragMove, (function(t) {
                        if (e.player.video.duration) {
                            ...
                            if (n < 0 || n > e.player.template.playedBarWrap.offsetWidth)
                                return;
                ...
                value: function() {
                    this.player.options.airplay && (window.WebKitPlaybackTargetAvailabilityEvent ? this.player.video.addEventListener("webkitplaybacktargetavailabilitychanged", function(e) {
        ...
        var we = function() {
            function e(t) {
                ...
                this.player.template.showDanmaku.addEventListener("click", (function() {
                    ...
                    a.player.template.showDanmakuToggle.checked ? (a.showDanmaku = !0,
                    a.player.danmaku.show()) : (a.showDanmaku = !1,
                    a.player.danmaku.hide()),
                ...
                this.player.template.unlimitDanmaku.addEventListener("click", (function() {
                    ...
                    a.player.template.unlimitDanmakuToggle.checked ? (a.unlimitDanmaku = !0,
                    a.player.danmaku.unlimit(!0)) : (a.unlimitDanmaku = !1,
                    a.player.danmaku.unlimit(!1)),
                ...
                }, o = 0; o < this.player.template.speedItem.length; o++)
                    n(o);
        ...
        var Le = function() {
            ...
            (a = [{
                ...
                value: function(e, t) {
                    ...
                    e + this.player.template.menu.offsetWidth >= a.width ? (this.player.template.menu.style.right = a.width - e + "px",
                    ...
                    t + this.player.template.menu.offsetHeight >= a.height ? (this.player.template.menu.style.bottom = a.height - t + "px",
          ...
          , je = function() {
            ...
            (a = [{
                ...
                value: function(e) {
                    ...
                    e || n.a.resolve(this.video.play()).catch((function() {
                        t.pause()
                    }
                    )).then((function() {}
                    )),
                ...
                value: function(e, t) {
                    ...
                    this.options.video.customType && this.options.video.customType[t])
                        "[object Function]" === Object.prototype.toString.call(this.options.video.customType[t]) ? this.options.video.customType[t](this.video, this) : console.error("Illegal customType: ".concat(t));
                    else
                ...
                value: function(e, t) {
                    ...
                    }, o = 0; o < this.events.videoEvents.length; o++)
                        n(o);
                    this.volume(this.user.get("volume"), !0, !0),
                    this.options.subtitle && (this.subtitle = new se(this.template.subtitle,this.video,this.options.subtitle,this.events),
                ...
                value: function(e) {
                    var t = this;
                    if (e = "string" == typeof e ? parseInt(e) : e,
